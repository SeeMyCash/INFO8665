...
def main() -> int:
    ...
    parser.add_argument("--role-arn", default="arn:aws:iam::REDACTED_ACCOUNT_ID:role/REDACTED_SAGEMAKER_ROLE")
    parser.add_argument("--bucket", default="smc-phase2-artifacts-redacted")
