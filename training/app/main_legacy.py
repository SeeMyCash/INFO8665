...
_openapi_tags = [
    ...
    {
        "name": "Static / UI",
        "description": "Serve the web front-end and React Native (Expo web) SPA.",
    },
]

app = FastAPI(
    title="See My Cash – Inference API",
    description=(
...
async def pipeline_infer(file: UploadFile = File(..., description="JPEG or PNG image file")):
