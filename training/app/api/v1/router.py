...
from app.api.v1.endpoints import health, inference, mlops, models, pipeline, storage

router = APIRouter()

router.include_router(health.router, prefix="", tags=["Health & Info"])
router.include_router(mlops.router, prefix="/mlops", tags=["ML Service Contracts"])
